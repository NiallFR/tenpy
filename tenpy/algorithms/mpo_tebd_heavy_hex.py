...
class MPO_TEBDEngine_HeavyHex(TEBDEngineHeavyHex):
    def __init__(self, F, model, layer_no, conserve, options, **kwargs):
    ...
    def evolve(self, N_steps, dt):
        ...
        connection_numbers = self.model.layers[self._layer_no]
        Us = self._U[self._layer_no]
...
class MPO_TEBDEngine_HeavyHex_Test(MPO_TEBDEngine_HeavyHex):
    def __init__(self, F, model, layer_no, conserve, options, **kwargs):
        MPO_TEBDEngine_HeavyHex.__init__(self, F, model, layer_no, conserve, options, **kwargs)
